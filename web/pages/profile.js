        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {!editing && (
            <button
              ...
              className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-xl font-medium transition-all shadow-lg hover:shadow-purple-500/30 flex items-center justify-center gap-2"
            >
